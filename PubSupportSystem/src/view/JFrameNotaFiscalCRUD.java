...
public class JFrameNotaFiscalCRUD extends javax.swing.JFrame {
    ...
    private void dataUp() throws SQLException {
        ...
        jTextFieldId.setText(Integer.toString(notaFiscal.getIdNotaFiscal()));
    ...
    private void initComponents() {
        ...
        jTextFieldValorAtracao.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldValorAtracaoActionPerformed(evt);
            }
        });
        ...
        jButtonAdicionarItemPedido.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonAdicionarItemPedidoActionPerformed(evt);
            }
        });
    ...
    private void jTextFieldValorConsumoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldValorConsumoActionPerformed
        System.out.println(resultValorConsumo.toString());
        jTextFieldValorConsumo.setText(resultValorConsumo.toString());
    ...
    private void jTextFieldValorAtracaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldValorAtracaoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextFieldValorAtracaoActionPerformed

    private void jButtonAdicionarItemPedidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarItemPedidoActionPerformed
        //adicionar produto -> consulta produto
    }//GEN-LAST:event_jButtonAdicionarItemPedidoActionPerformed
