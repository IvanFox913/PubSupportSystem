 ...
 * @author saradu
 */
public class JFrameConsultaTipoProduto extends javax.swing.JFrame {

    private TipoProduto tipoProduto;
    private boolean select;
    private boolean disconnectOnClose;
    
    private String query = "SELECT ID_TIPO_PRODUTO AS ID, NOME_TIPO AS TIPO_DE_PRODUTO FROM TIPO_PRODUTO ORDER BY ID_TIPO_PRODUTO";
    
    private ResultSetTableModel result;
    private final TableRowSorter< TableModel > filter;
    
    /**
     * Creates new form JFrameConsultaTipoProduto
     */
    public JFrameConsultaTipoProduto(boolean select, boolean disconnectOnClose, TipoProduto tipoProduto) throws SQLException{
        initComponents();
    ...
    private void jButtonSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelecionarActionPerformed
        ...
        if( row != -1 ) {
            ...
            this.tipoProduto.setIdTipoProduto(codigo);
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        if( row != -1 ) {
            ...
            tipoProduto.setIdTipoProduto(codigo);
            ...
            try {
                ...
                jFrameCRUD = new JFrameTipoProdutoCRUD( tipoProduto, false );
    ...
    private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarActionPerformed
        ...
        JFrameTipoProdutoCRUD jFrameCRUD;
        jFrameCRUD = new JFrameTipoProdutoCRUD( null, false );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameConsultaTipoProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new JFrameConsultaTipoProduto(false,true,null).setVisible(true);
