...
public class JFrameConsultaAtracao extends javax.swing.JFrame {
    ...
    private String query = "SELECT atracao.id_atracao AS ID, atracao.descricao AS Descrição, atracao.preco AS Preço FROM atracao ORDER BY Descricao";
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        if(row != -1){
            ...
            try {
                ...
                JFrameAtracaoCRUD jFrameCRUD;
                jFrameCRUD = new JFrameAtracaoCRUD(atracao, false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameConsultaAtracao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
